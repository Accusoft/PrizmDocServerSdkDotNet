...
namespace Accusoft.PrizmDocServer.Conversion.Tests
{
    ...
    public class ConvertAsync_Jpeg_Tests
    {
        ...
        public async Task With_local_file_path()
        {
            ...
            IEnumerable<Result> results = await prizmDocServer.ConvertAsync("documents/example.docx", DestinationFileFormat.Jpeg);
        ...
        {
            PrizmDocServerClient prizmDocServer = Util.CreatePrizmDocServerClient();
            IEnumerable<Result> results = await prizmDocServer.ConvertAsync("documents/example.docx", new DestinationOptions(DestinationFileFormat.Jpeg)
            {
