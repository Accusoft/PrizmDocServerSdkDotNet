...
namespace Accusoft.PrizmDocServer.PlainTextRedaction.KnownServerErrors.Tests
{
    ...
    {
        [TestMethod]
        public async Task RedactToPlainTextAsync_fails_with_a_useful_error_message_when_the_markup_json_file_contains_content_which_does_not_pass_schema_validation()
        {
            ...
            await UtilAssert.ThrowsExceptionWithMessageAsync<RestApiErrorException>(
                async () =>
                {
                    await prizmDocServer.RedactToPlainTextAsync("documents/confidential-contacts.pdf", "documents/content-fails-schema-validation.markup.json", "\n");
