...
namespace Accusoft.PrizmDocServer.PlainTextRedaction.KnownServerErrors.Tests
{
    ...
    {
        [TestMethod]
        public async Task RedactToPlainTextAsync_fails_with_a_useful_error_message_when_the_source_document_cannot_be_found()
        {
            ...
            await UtilAssert.ThrowsExceptionWithMessageAsync<RestApiErrorException>(
                async () =>
                {
                    await prizmDocServer.RedactToPlainTextAsync(nonExistentSourceDocument, existingMarkupFile, "\n");
